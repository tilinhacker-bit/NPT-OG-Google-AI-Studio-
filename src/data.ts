...
export const ZH_NAMES: Record<string, string> = {
  "Myat Myat Aung": "妙妙昂",
  "Wah Wah Win Hlaing": "娃哇温莱",
  "Win Min Than": "温敏丹",
  "Aye Myint Thet": "埃敏德",
  "Darli Nyein Chan": "达莉宁千",
  "Linn Bo": "林波",
  "Nay Aung Oo": "内昂乌",
  "Kay Thi Myo Myint": "凯迪妙敏",
  "Cho May Mi Htet Naung": "秋梅米特囊",
  "Yin Mon Aung": "银门昂",
  "Kay Kay Khine": "凯凯凯",
  "Nway Nay Chi Hlaing": "内内奇莱",
  "Phyo Zin Maung": "漂津貌",
  "Theint Thinzar Kyaw": "登丁萨觉",
  "Phyu Sin Aye": "漂辛埃",
  "Myo Thwin Thein": "妙温丹",
  "Htet Phyo Kyaw": "特漂觉",
  "Han Myint Mo Mo": "汉敏莫莫",
  "Nang Sanda Htun": "楠珊达吞",
  "Nan Sandar Tun": "楠珊达吞",
  "May Thu Khaing": "梅杜凯",
  "Hlaing Myo Oo": "莱妙乌",
  "Thukha Wynn": "杜卡温",
  "Nay Linn Oo": "内林乌",
  "Myat Min Khant": "妙敏坎",
  "Phoo Pyae Pyae Hlaing": "普毕毕莱",
  "Phu Myat Thwe": "普妙推",
  "Myo Min Kyaw": "妙敏觉",
  "Myat Mon Mon Kyaw": "妙门门觉",
  "May Thet Paing Kyaw": "梅德拜觉",
  "Aung Kaung Thant Kyaw": "昂冈丹觉",
  "Dazen Kyaw": "达曾觉",
  "Hsu Mon Kyaw": "苏门觉",
  "Kaung Myat Htal": "冈妙泰",
  "Mon Mon Thant": "门门丹",
  "Mon Mon Theint Kyaw": "门门德觉",
};
